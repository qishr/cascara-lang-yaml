...
public class EventValidator {
    ...
    public EventValidator(List<StreamingEvent> events) {
        this.events = new ArrayDeque<>();
        this.events.addAll(events);
        expectations = new ArrayDeque<>();
    }
    public EventValidator expect(StreamingEventType type) {
        expectations.add(new Expectation(type, false, null));
        return this;
    }
    public EventValidator expect(StreamingEventType type, String value) {
        expectations.add(new Expectation(type, true, value));
        return this;

    }
    public EventValidator verbose() {
        verbose = true;
        return this;
    }
